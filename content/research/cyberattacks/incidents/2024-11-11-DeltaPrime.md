...
Public analysis diverged on whether that description fully captured the exploit chain. DeltaPrime publicly attributed the incident primarily to reward-claim impersonation. CertiK publicly analyzed it as a chained two-vulnerability exploit that included, but was not limited to, reward-claim abuse: one flaw in debt-swap handling that allowed borrowed assets to be routed to an attacker-controlled contract without normal repayment effects, and another in reward-claim handling that accepted attacker-controlled external input and let collateral be withdrawn as apparent rewards. DeltaPrime's post-mortem reported a total loss of about $4.75 million, while third-party estimates clustered closer to about $4.85 million.
...
- **November 11, 2024, 07:49 UTC:** DeltaPrime said the attacker [moved part of the Avalanche proceeds to Trader Joe and pools](https://snowtrace.io/tx/0xac2d68d225c00dbaced446281e034a52d6edef330b87352bf7679c3f463501a0?chainid=43114).
