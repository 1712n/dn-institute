...
- **Loss:** The repo's [BonqDAO incident page](https://dn.institute/attacks/posts/2023-02-01-BonqDAO/) describes the exploit path as roughly [$100 million BEUR minted](https://dn.institute/attacks/posts/2023-02-01-BonqDAO/) and an estimated nominal loss around [$120 million](https://dn.institute/attacks/posts/2023-02-01-BonqDAO/), while outside reporting noted that much of the stolen or minted value was illiquid and the attacker appears to have realized under $2 million.
