...
- **Details:** The attacker used a flash loan of nearly [$1 billion](https://dn.institute/attacks/posts/2022-04-17-Beanstalk/) in assets to gain a 67% governance supermajority, then executed malicious proposal BIP-18 while pairing it with BIP-19, a Ukraine-donation proposal that helped provide political cover; reporting on the incident says the attacker removed about $182 million and netted roughly [$80 million](https://dn.institute/attacks/posts/2022-04-17-Beanstalk/) after repayments and slippage.
