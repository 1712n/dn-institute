---
title: "SEC Alleges Systematic Wash Trading of TRX by Justin Sun and Tron Foundation"
date: 2018-04-18 — 2019-02-11
entities:
  - Tron Foundation
  - Justin Sun
  - TRX
...
TRON is a blockchain platform founded by Justin Sun in 2017. Its native token, Tronix (TRX), was distributed through an initial coin offering (ICO) that raised approximately $70 million. Sun subsequently used proceeds to acquire BitTorrent, the peer-to-peer file sharing protocol, for $140 million in 2018, and launched the BitTorrent Token (BTT).

By 2023, the TRON blockchain had become the dominant network for Tether (USDT) stablecoin transfers, with over $43 billion in USDT issued on the network. This made TRX trading volume a critical metric for the ecosystem's perceived health and adoption.

### Regulatory Context

The SEC's complaint (Case 1:23-cv-02433, Southern District of New York) charged Sun and his companies with two categories of violations:
- **Unregistered securities offerings** of TRX and BTT through "bounty programs" and "airdrops"
- **Market manipulation** through systematic wash trading of TRX
...
According to the SEC complaint (paragraphs 157–173), the wash trading operation was structured as follows:

- **Director**: Justin Sun personally directed the scheme and provided TRX from his own holdings to fund it
- **Execution team**: At least three Tron Foundation employees and two Rainberry employees
- **Method**: Simultaneous buy and sell orders of TRX between two accounts (designated "Account 16" and "Account 17" in the complaint) controlled by the same beneficial owner
- **Platform**: At least one U.S.-based cryptocurrency trading platform
- **Duration**: Approximately April 18, 2018 through February 11, 2019 (249 active trading days)

### Quantitative Evidence

The SEC's complaint provides specific quantitative data on the wash trading activity:

| Metric | Value |
|--------|-------|
| Total wash trades | 609,790 |
| Active trading days | 249 |
| Average daily wash trades | ~2,449 |
| Daily budget | ~2.5 BTC (~$16,000 at Oct 2018 prices) |
| Accounts involved | 2 (Account 16 and Account 17) |
| Team size | ≥5 employees |

The complaint includes a detailed example of wash trading activity on **October 1, 2018**, showing matched buy and sell orders between the two accounts within short time intervals, creating the appearance of legitimate trading activity without any actual change in beneficial ownership.

### Internal Communications

The SEC cited internal communications that revealed the deliberate nature of the scheme. In one instance, a Sun employee wrote:

> "The boss reminded us of the need to increase trade volume, we need to increase the liquid parameter next week, concentrate on binance, bittrex, bithumb, upbit exchanges."

This communication demonstrates that:
1. The directive came directly from Sun ("the boss")
...
- **Attracting retail investors** who interpreted high volume as a signal of genuine market interest
- **Maintaining exchange listings** on platforms that required minimum trading volume thresholds
...
| Celebrity | Settlement | Penalties |
|-----------|-----------|-----------|
| Lindsay Lohan | Settled | Part of $400,000+ combined |
| Jake Paul | Settled | Part of $400,000+ combined |
| Ne-Yo (Shaffer Smith) | Settled | Part of $400,000+ combined |
| Akon | Settled | Part of $400,000+ combined |
| Lil Yachty | Settled | Part of $400,000+ combined |
| Kendra Lust | Settled | Part of $400,000+ combined |
| Soulja Boy (DeAndre Cortez Way) | Ongoing | — |
| Austin Mahone | Settled Aug 2023 | $45,724 total |
...
The 609,790 wash trades over 249 days represent a significant portion of TRX's reported trading activity during this period. Since wash trades involve no change in beneficial ownership, they contribute zero genuine price discovery while inflating volume metrics. This creates a disconnect between reported volume and actual market participation — a pattern detectable through volume-volatility correlation analysis, where high volume fails to produce corresponding price movement.

### Temporal Patterns

With an average of 2,449 wash trades per day executed by a small team, the trading activity likely exhibited mechanical timing patterns characteristic of coordinated or automated execution. Such patterns — including regular trade intervals and consistent trade sizes — are detectable through time-of-trade distribution analysis.
...
- **2023**: Six celebrities settle with the SEC for combined $400,000+
- **February 2025**: SEC and Sun's legal team jointly file for a stay in proceedings while considering a potential resolution
- **As of February 2026**: No resolution has been announced; the case remains paused
...
1. SEC Complaint, Case 1:23-cv-02433 (S.D.N.Y., March 22, 2023). [PDF](https://www.sec.gov/files/litigation/complaints/2023/comp-pr2023-59.pdf)
