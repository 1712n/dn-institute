...
- **Lack of Contract Validation:** The GPv2Settlement contract, part of the CoW Swap protocol, did not validate the token received in the settle() function, allowing the attackers to force it to approve a malicious contract.
...
- **Lack of Access Control:** The smart contracts did not have properly implemented access control measures, which exposed sensitive functions externally.
