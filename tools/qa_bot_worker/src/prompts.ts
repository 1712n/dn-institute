/**
 * Prompts ported from tools/article_checker/claude_retriever/client.py
 * and refined for the CF Worker implementation.
 */

export const EXTRACTING_PROMPT = `You are an attentive fact-checking specialist. Please extract important statements that appear to be factual from the text provided between <text></text> tags.
...
- Your Headers: \`# Cryptocurrency Scam Types ...\` :x:
...
- Notes: 
    - The \`date\` header has an incorrect date. ":warning:"
'''

The output must comply with Markdown format. Include in the output only what is specified in the instructions.`;
