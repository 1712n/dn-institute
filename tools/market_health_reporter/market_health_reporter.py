...
from tools.market_health_reporter.rag_context import retrieve_context  # 🌰 RAG
...
def main():
    ...
    try:
        ...
        # 🌰 Retrieve RAG context from local KB + web search
        ...
        if rag_context:
            ...
            print("No RAG context found (proceeding without)")
