...
The QA bot for article checks has been migrated to a Cloudflare Worker. This change leverages serverless architecture for improved efficiency and scalability.
