...
- The QA bot for article checks has been migrated to a Cloudflare Worker. You can find the worker script in the `workers/qa-bot.js` file.
- The worker is triggered by webhooks from GitHub and performs quality checks on pull requests.
