/**
 * All LLM prompt templates used by the article checker.
 * These are direct ports from the Python client.py prompts.
 */

/**
 * Prompt for extracting factual statements from article text.
 */
...
/**
 * Prompt for retrieval-augmented fact-checking of statements.
 * Contains {current_time} and {description} placeholders.
 */
...
/**
 * Prompt for generating the final answer with fact-checking results,
 * editor notes, Hugo formatting checks, and metadata validation.
 */
