// 🌰 Prompts ported from the original Python article checker 🌰
// These prompts drive the fact-checking and review pipeline.

/** 🌰 Prompt to extract factual statements from article text */
...
/** 🌰 Prompt template for fact-checking statements via search */
...
You are tasked with verifying the accuracy of a series of factual statements using a search engine. Below is the search engine's description: <tool_description>${toolDescription}</tool_description>.
...
/** 🌰 Prompt for generating the final review comment */
...
/** 🌰 Brave Search tool description (used in the retrieval prompt) */
