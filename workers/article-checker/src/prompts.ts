/**
 * prompts.ts — Exact ports of the three prompts from the Python claude_retriever client.
 *
 * These must stay byte-for-byte identical to the originals so that model behaviour
 * remains consistent across the migration.
 *
...
// ---------------------------------------------------------------------------
// EXTRACTING_PROMPT
// Used by extractStatements() with claude-3-opus to pull factual claims out of
// the article text.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// RETRIEVAL_PROMPT
// Used by retrieve() — the iterative search-and-verify loop.
// {current_time} and {description} are interpolated at runtime.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// ANSWER_PROMPT
// Used by answerWithResults() — generates the full editor's report from the
// accumulated fact-checking results.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Brave search tool description (used inside RETRIEVAL_PROMPT)
// ---------------------------------------------------------------------------
